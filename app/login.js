...
(function () {
  ...
  function clientFile(user, prof, id) {
    ...
    function draw(c) {
      ...
      var repBox = el('div', { id: 'repbox' }); var letBox = el('div', { id: 'letbox' }); var othBox = el('div', {}); var monBox = el('div', { id: 'monbox' }); var agrBox = el('div', { id: 'agrbox' });
      show([el('div', { class: 'bar' }, [backBtn(), signOutBtn(true)]), h1, f,
        el('h2', { text: 'Private details' }),
        el('p', { class: 'sub', text: 'Stored encrypted. Only revealed on request, and every reveal is recorded in the activity log.' }), out, rev, sf, agrBox, repBox, letBox, othBox, monBox]);
      if (window.NCPAgreement) window.NCPAgreement.mount(agrBox, { sb: sb, clientId: id, prof: prof, user: user });
